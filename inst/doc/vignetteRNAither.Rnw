...
is the B-score (see~\ref{whatnormchoose}). Furthermore, to account for effects of cell counts on 
signal intensities, a lowess normalization was performed. 
...
{\tt
rnaither(datasetDrosophila, expname="Drosophila", excludeCellcounts="none", logtransform=FALSE, normalization="bscore", test="none", scorethresh=2.0, outdir="results", reorder=F)
}
